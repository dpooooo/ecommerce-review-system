const aliases: Record<string, string[]> = {
  ...
  gsv: ["GSV", "实收金额", "净销售额"],
  orders: ["订单数", "成交订单数", "支付订单数", "总订单行", "总订单数"],
  conversionRate: ["转化率", "支付转化率", "成交转化率"],
  aov: ["客单价", "平均客单价"],
  refundAmount: ["退款金额", "售后金额"],
  refundRate: ["退款率", "售后率"],
  spend: ["推广花费", "消耗", "花费"],
  impressions: ["展现", "展现量", "展现数", "曝光", "曝光量", "展示数"],
  clicks: ["点击", "点击量", "点击数"],
  ctr: ["CTR", "点击率"],
  cpc: ["CPC", "平均点击花费", "平均点击成本"],
  cpm: ["CPM", "千次展现成本"],
  promoGmv: ["推广成交", "推广成交金额", "广告成交", "广告成交金额"],
  roi: ["ROI", "投入产出比", "投产比"],
  directOrders: ["直接订单行", "直接订单数"],
  directRevenue: ["直接订单金额"],
  indirectOrders: ["间接订单行", "间接订单数"],
  indirectRevenue: ["间接订单金额"],
  addCarts: ["总加购数", "加购数"],
  addCartRate: ["加购率"],
  orderCost: ["平均订单成本", "订单成本"],
  newCustomerOrders: ["下单新客数", "新客订单数"],
  adVisitors: ["广告访客数"],
